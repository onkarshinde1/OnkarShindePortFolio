  ...
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="w-63 sm:w-80 rounded-3xl max-w-none">
          <Image
            src={assets.user_image}
            alt="user_image "
            className="w-full rounded-3xl border-[0.5px] border-darkhover"
          />
        </div>
        <div className="flex-1">
          ...
          <h4 className="my-7 text-gray-500 font-ovo">Tools I Use</h4>
